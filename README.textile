...
| "Get on the Rails Composer mailing list":http://mailinglist.railscomposer.com/ | "Subscribe at $19/mo to support the project":http://railsapps.github.io/ |

h4. From the RailsApps Project

The "RailsApps project":http://railsapps.github.io/ provides example applications that developers use as starter apps. Hundreds of developers use the apps, report problems as they arise, and propose solutions. Rails changes frequently; each application is known to work and serves as your personal "reference implementation." You can use Rails Composer to build any of the example applications.

If you use Rails Composer, please "join RailsApps":http://railsapps.github.io/ to support the project. "Sign up for the Rails Composer mailing list":http://mailinglist.railscomposer.com/ for news and announcements.
...
| "rails-omniauth":https://github.com/RailsApps/rails-omniauth | "OmniAuth Tutorial":http://railsapps.github.io/rails-omniauth/ | authentication with OmniAuth |
...
| "rails-devise-pundit":https://github.com/RailsApps/rails-devise-pundit | "Rails Pundit Tutorial":http://railsapps.github.io/rails-devise-pundit/ | authorization with Pundit |
| "rails-signup-download":https://github.com/RailsApps/rails-signup-download | "Rails Signup Download":https://tutorials.railsapps.org/rails-signup-download | Devise plus download a PDF file |

h4. The rails_apps_composer Gem

Want to contribute a starter app you've created? Or need to customize the Rails Composer application template? The Rails Composer application template is built from recipes provided by the "rails_apps_composer":https://github.com/RailsApps/rails_apps_composer gem.
...
<pre>
$ rails new myapp -m https://raw.github.com/noriaki/rails-composer/mongoid_spike/composer.rb
</pre>
...
$ gem install rails
$ rails new . -m https://raw.github.com/noriaki/rails-composer/mongoid_spike/composer.rb
</pre>
...
Choose "SQLite" for the easiest setup. If you choose PostgreSQL or MySQL or Mongodb(mongoid), the databases must be installed and running before you run Rails Composer.
...
Currently, there are no contributed applications available for Rails 4.1. If you would like to add your favorite starter application to Rails Composer, open an issue to let us know.
...
<pre>
# ~/.railsrc
-m https://raw.github.com/noriaki/rails-composer/mongoid_spike/composer.rb
</pre>
